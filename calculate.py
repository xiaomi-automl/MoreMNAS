...
if __name__ == '__main__':
    ...
    for calculate_path in calculate_path_list:
        ...
        # hr_images = [scipy.imageio.imread(p, mode='RGB') for p in calculate_hr_img_list]
        # lr_images = [scipy.imageio.imread(p, mode='RGB') for p in calculate_lr_img_list]
        hr_images = [imageio.imread(p) for p in calculate_hr_img_list]
        lr_images = [imageio.imread(p) for p in calculate_lr_img_list]
